...
local function zd_shouldDebuff(unit)
...
local function zd_debuffPet(pet)
    pet:CastCustomSpell(pet, 72341, false, Config.DamageTaken,Config.DamageDone)
end
